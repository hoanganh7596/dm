...
public class StoredXssComments extends AssignmentEndpoint {
  ...
  public AttackResult createNewComment(@RequestBody String commentStr) {
      ...
      // Mã hóa bình luận để ngăn chặn XSS
      String sanitizedCommentText = StringEscapeUtils.escapeHtml4(comment.getText());
      comment.setText(sanitizedCommentText);
      ...
      if (sanitizedCommentText.contains(phoneHomeString)) {
